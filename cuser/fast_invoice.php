...
if ($wid <= 0) {
    die('<div style="text-align:center;padding:50px;font-family:Tahoma;">گارسنی برای این کاربر یافت نشد.</div>');
}
...
if ($cfid <= 0) {
    die('<div style="text-align:center;padding:50px;font-family:Tahoma;">کافه‌ای برای این گارسون یافت نشد.</div>');
}
