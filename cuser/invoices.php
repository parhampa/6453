        ...
        <div class="col-md-10 col-lg-8">
            <div class="panel-card">
                ...
                <div class="card-body p-4">
                    ...
                    // ⭐ دکمه «مشاهده فاکتور» به هر ردیف جدول
                    ...
                    /* ⭐ فیلتر: فقط فاکتورهای خود گارسون */
                    $fm->setwhere(" `waiter_id`=$wid ");
                    $fm->deletewhere(" `waiter_id`=$wid ");
                    $fm->set_where_edit(" `waiter_id`=$wid ");

                    /* ⭐ مقادیر پیش‌فرض: گارسون جاری + کافه‌ی گارسون */
                    $fm->set_int_val("waiter_id", $wid);
                    ...
                    // مشتری مورد نظر (اجباری - نمایش در جدول)
                    ...
                    $db->connect()->query("SELECT id, name, family FROM customers");
