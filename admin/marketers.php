        ...
        <div class="col-md-8 col-lg-6">
            <div class="panel-card">
                ...
                <div class="card-body p-4">
                    <?php
                    $fm = new makeform();
                    $fm->set_tbl_key("marketers", "id", 1, "تعریف بازاریابان");
                    $fm->CSRF_token();

                    // نام (اجباری - نمایش در جدول) - نوع: متنی (0)
                    ...
                    // نام خانوادگی (اجباری - نمایش در جدول) - نوع: متنی (0)
                    ...
                    // وضعیت (اجباری - نمایش در جدول) - نوع: سلکت‌باکس (2)
