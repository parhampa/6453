...
<ul class="sidebar-menu" id="sidebarMenu">
    ...
    <!-- ========== گروه: مدیریت کاربران ========== -->
    <li class="menu-group <?php echo $open_group === 'groupUsers' ? 'has-active' : ''; ?>">
        <a class="menu-group-toggle <?php echo $open_group !== 'groupUsers' ? 'collapsed' : ''; ?>"
           data-bs-toggle="collapse" href="#groupUsers"
           role="button"
           aria-expanded="<?php echo $open_group === 'groupUsers' ? 'true' : 'false'; ?>"
           aria-controls="groupUsers">
            <i class="fas fa-users-gear"></i>
            <span>مدیریت کاربران</span>
            <i class="fas fa-chevron-down menu-arrow"></i>
        </a>
        <ul class="collapse submenu <?php echo $open_group === 'groupUsers' ? 'show' : ''; ?>" id="groupUsers">
            <li>
                <a href="admin_user.php?action=show"
                   class="<?php echo is_active('admin_user.php', $current_page); ?>">
                    <i class="fas fa-user-shield"></i>
                    مدیران سیستم
                </a>
            </li>
            <li>
                <a href="marketers.php?action=show"
                   class="<?php echo is_active('marketers.php', $current_page); ?>">
                    <i class="fas fa-user-tie"></i>
                    بازاریابان
                </a>
            </li>
            <li>
                <a href="customers.php?action=show"
                   class="<?php echo is_active('customers.php', $current_page); ?>">
        ...
        <ul class="collapse submenu <?php echo $open_group === 'groupCafes' ? 'show' : ''; ?>" id="groupCafes">
            <li>
                <a href="cafes.php?action=show"
                   class="<?php echo is_active('cafes.php', $current_page); ?>">
