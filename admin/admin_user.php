        ...
        <div class="col-md-10 col-lg-8">
            <div class="panel-card">
                ...
                <div class="card-body p-4">
                    ...
                    // نام کاربری (اجباری - نمایش در جدول)
                    $fm->label("نام کاربری", "form-label")
                        ->input()
                        ->inpname("username")
                        ->inpid("username")
                        ->inptype("text")
                    ...
                    // کلمه عبور (اجباری - عدم نمایش در جدول)
                    ...
                    // نام خانوادگی (اجباری - نمایش در جدول)
                    ...
                    // شماره تماس (اجباری - نمایش در جدول)
                    ...
                    // ایمیل (اجباری - نمایش در جدول)
                    $fm->label("ایمیل", "form-label")
                        ->input()
                        ->inpname("email")
                        ->inpid("email")
                        ->inptype("text")
                    ...
                    // وضعیت (اجباری - نمایش در جدول)
                    $fm->label("وضعیت", "form-label")
                        ->select()
                        ->selectname("active")
                        ->selectid("active")
                        ->selectaddval(1, "فعال")
